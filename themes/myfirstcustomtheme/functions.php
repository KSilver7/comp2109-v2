...
/**
 * The following PHP Hooks are the default hooks for WooCommerce. They are listed here so we don't have to search them out
 * 
 * Before content
 ...
 * add_action( 'woocommerce_before_quantity_input_field' );
 * add_action( 'woocommerce_after_quantity_input_field' );
 ...
 * add_action( 'woocommerce_review_after_comment_text', 'woocommerce_review_display_comment_text', 10 );
